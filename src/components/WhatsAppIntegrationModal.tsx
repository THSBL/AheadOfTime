      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-stone-200 bg-stone-50/80">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-aot-sage text-[#182A42] flex items-center justify-center shadow-sm">
                ...
                <div className="bg-white p-5 rounded-xl border border-stone-200 shadow-sm space-y-4">
                  ...
                  <div className="space-y-3 pt-2">
                    ...
                    <button
                      ...
                      className="w-full py-2.5 px-4 bg-aot-sage hover:bg-aot-sage-hover text-[#182A42] text-xs font-medium rounded-lg flex items-center justify-center gap-2 shadow-sm transition-all disabled:opacity-50"
                    >
                      {isSendingOutreach ? (
                        <>
              ...
              <div className="bg-white p-6 rounded-xl border border-stone-200 shadow-sm">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <button
                    ...
                    disabled={isScanning}
                    className="py-2.5 px-5 bg-aot-sage hover:bg-aot-sage-hover text-[#182A42] text-xs font-semibold rounded-lg flex items-center gap-2 shadow-sm transition-all whitespace-nowrap self-start disabled:opacity-50"
                  >
                    {isScanning ? (
                      <>
